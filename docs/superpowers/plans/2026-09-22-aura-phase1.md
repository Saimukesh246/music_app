...
- [ ] **Step 5: Verify pnpm is available and workspace file is valid**
...
- [ ] **Step 3: Write `packages/shared/src/provider.ts`**
...
- [ ] **Step 4: Write `packages/shared/src/fixtures.ts`**
...
- [ ] **Step 5: Write `packages/shared/src/mockProvider.ts`**
...
- [ ] **Step 5: Create `apps/mobile/jest.config.js`**
...
- [ ] **Step 6: Create placeholder `apps/mobile/App.tsx`**
...
- [ ] **Step 1: Write `apps/mobile/src/theme/tokens.ts`**
...
- [ ] **Step 2: Write `apps/mobile/src/providers/index.ts`**
...
- [ ] **Step 1: Write `apps/mobile/src/store/playerStore.ts`**
...
- [ ] **Step 2: Write `apps/mobile/src/store/libraryStore.ts`**
...
- [ ] **Step 3: Write `apps/mobile/src/components/QualityBadge.tsx`**
...
- [ ] **Step 1: Write `apps/mobile/src/components/ArtworkCard.tsx`**
...
- [ ] **Step 2: Write `apps/mobile/src/components/TrackRow.tsx`**
...
- [ ] **Step 1: Write `apps/mobile/src/components/MiniPlayer.tsx`**
...
- [ ] **Step 1: Write `apps/mobile/src/screens/HomeScreen.tsx`**
...
- [ ] **Step 2: Write `apps/mobile/src/screens/SearchScreen.tsx`**
...
- [ ] **Step 3: Write `apps/mobile/src/screens/LibraryScreen.tsx`**
...
- [ ] **Step 4: Write `apps/mobile/src/screens/SettingsScreen.tsx`**
...
- [ ] **Step 1: Write `apps/mobile/src/screens/NowPlayingScreen.tsx`**
...
- [ ] **Step 1: Write `apps/mobile/src/navigation/TabNavigator.tsx`**
...
- [ ] **Step 2: Write the failing navigation smoke test**
...
- [ ] **Step 4: Write `apps/mobile/src/navigation/RootNavigator.tsx`**
...
- [ ] **Step 6: Wire `App.tsx` to `RootNavigator`**
...
- [ ] **Step 2: Open in the built-in browser preview or a connected device/simulator and verify:**
